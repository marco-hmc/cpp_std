...
namespace MyStd::ListImpl1 {
    ...
    struct List {
      ...
      public:
        List() noexcept { m_dummy.m_prev = m_dummy.m_next = &m_dummy; }
      ...
      public:
        [[nodiscard]] [[nodiscard]] std::size_t size() const noexcept {
            return m_size;
        }
        ...
        struct iterator {
          ...
          public:
            ...
            const iterator operator--(int) noexcept {  // iterator--
                auto tmp = *this;
                --*this;
                return tmp;
            }
        ...
        struct const_iterator {
          ...
          public:
            ...
            const const_iterator operator++(int) noexcept {  // iterator++
                auto tmp = *this;
                ++*this;
                return tmp;
            }
        ...
        iterator erase(const_iterator pos) noexcept {
            auto *node = const_cast<ListNode *>(pos.m_curr);
